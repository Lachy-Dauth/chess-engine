...
const piecesValues = {
  ...
  'K': [-30, -40, -40, -50, -50, -40, -40, -30, -30, -40, -40, -50, -50, -40, -40, -30, -30, -40, -40, -50, -50, -40, -40, -30, -30, -40, -40, -50, -50, -40, -40, -30, -20, -30, -30, -40, -40, -30, -30, -20, -10, -20, -20, -20, -20, -20, -20, -10, 20, 20, 0, 0, 0, 0, 20, 20, 30, 50, 20, 0, 0, 20, 50, 30],
  ...
  'k': [-30, -50, -20, 0, 0, -20, -50, -30, -20, -20, 0, 0, 0, 0, -20, -20, 10, 20, 20, 20, 20, 20, 20, 10, 20, 30, 30, 40, 40, 30, 30, 20, 30, 40, 40, 50, 50, 40, 40, 30, 30, 40, 40, 50, 50, 40, 40, 30, 30, 40, 40, 50, 50, 40, 40, 30, 30, 40, 40, 50, 50, 40, 40, 30],
...
function evaluation(board, whitesTurn, enPassent, blackCastle, whiteCastle, depth, alpha, beta, originalDepth, previousPositionsMinimax) {
  ...
  if (whitesTurn) {
    ...
    for (let i = 0; i < allValidMoves.length; i++) {
      ...
      let score = evaluation(...movePieceAI(move, board, whitesTurn, enPassent, blackCastle, whiteCastle), depth - 1 - Math.floor(i/5), alpha, beta, originalDepth, previousPositionsMinimax)[0];
      if (score > max) {
        max = score;
        bestMove = move;
      }
...
function evaluationDepth0(board, whitesTurn, enPassent, blackCastle, whiteCastle) {
  let totalWhite = whiteCastle.filter(Boolean).length * 10;
  let totalBlack = blackCastle.filter(Boolean).length * 10;
  let whiteKingPos;
  let blackKingPos;
  for (let i = 0; i < 64; i++) {
    if (board[i] != null) {
